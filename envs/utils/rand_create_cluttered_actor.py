...
def get_all_cluttered_objects():
    ...
    cluttered_objects_config = json.load(open(Path("/mnt/workspace/yama/robotwin_data/assets/objects/objaverse/list.json"), "r", encoding="utf-8"))
    ...
    # load from objects
    objects_dir = Path("/mnt/workspace/yama/robotwin_data/assets/objects")
    ...
    same_obj = json.load(open(Path("/mnt/workspace/yama/robotwin_data/assets/objects/same.json"), "r", encoding="utf-8"))
